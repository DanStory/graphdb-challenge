    ...
    (0, _createClass3.default)(HubConnection, [{
        ...
        value: function invoke(methodName) {
            ...
            var p = new _promise2.default(function (resolve, reject) {
                _this4.callbacks.set(invocationDescriptor.invocationId, function (invocationEvent) {
                    if (invocationEvent.type === 3 /* Completion */) {
                            var completionMessage = invocationEvent;
                            if (completionMessage.error) {
                ...
                var message = _this4.protocol.writeMessage(invocationDescriptor);
                _this4.connection.send(message).catch(function (e) {
                    reject(e);
